...
def save_config(time, log):
    ...
    log_file = open(get_path('/home/kemove/keyu/newpan/log/' + str(time) + '/records.txt'), open_type)
    log_file.write(str(log) + '\n')

def save_net_config(time, log):
    open_type = 'a' if os.path.exists(get_path('./log/' + str(time) + '/net.txt'))else 'w'
    log_file = open(get_path('/home/kemove/keyu/newpan/log/' + str(time) + '/net.txt'), open_type)
    log_file.write(str(log) + '\n')
